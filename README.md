...
<h4 align="center">With +2 years of IT experience, including +1 year in DevOps, demonstrates a strong passion for automating IT operations and staying abreast of emerging technologies. Expertise includes implementing and managing CI/CD pipelines (Jenkins), containerization, orchestration, monitoring, and automating production infrastructure. Proven ability to build tools that minimize errors, perform root cause analysis, and enhance customer experience. 

Certified as a **HashiCorp Terraform Associate, Azure Fundamentals, and Certified Kubernetes Administrator (CKA),** with proficiency in infrastructure as code using Terraform. Experienced in using Jira for agile project management and recognized for strong communication, adaptability, and teamwork. Known for emphasizing innovative solutions and rigorous testing practices. Background includes utilizing automation tools for software updates across cloud platforms (AWS, Azure), optimizing cloud resources, and managing costs to ensure reliability, scalability, and performance for both enterprise and commercial clients.</h4>
